...
export const useBootstrap = () => {
  ...
  return {
    ...
    openCreateNoteModal: noteStore.openCreateNoteModal,
    openEditNoteMetaModal: noteStore.openEditNoteMetaModal,
    openNoteById: noteStore.openNoteById,
    saveCurrentNote: noteStore.saveCurrentNote,
    selectFolder,
    selectNote: noteStore.selectNote,
    submitNoteMetaModal: noteStore.submitNoteMetaModal,
